  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        opacity: { type: "number", minimum: 0, maximum: 1, default: 0.55, description: "水印透明度，0 为完全透明，1 为完全不透明。" },
        font_size: { type: "integer", minimum: 8, maximum: 500, description: "字体大小；不传时按图片宽度自动计算。" },
      },
    },
  },
